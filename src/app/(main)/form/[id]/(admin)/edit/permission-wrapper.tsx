...
export function PermissionWrapper({
  ...
  const pendingInvitation = useQuery(api.collaborators.getPendingInvitationForForm, {
    formId: formId as Id<"forms">,
  });
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm">{formatDate(pendingInvitation.invitedAt)}</span>
            </div>
          </div>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {fallbackMessage || `You don't have permission to ${requiredPermission} this form.`}
        </CardDescription>
      </CardHeader>
      <CardContent>
