...
const fakeChatData = [
  ...
  },
  {
    ...
    content: "I'll help you create a customer feedback form. Let me gather some information about your existing forms and then we can build a comprehensive feedback form together.",
    timestamp: "2:35 PM"
  },
  {
    id: 3,
  ...
  },
  {
    id: 5,
    type: "assistant" as const,
    content: "Perfect! I found your existing forms and configuration files. Based on your current setup, I can help you create a customer feedback form that integrates well with your existing system. Would you like me to start building the form structure?",
    timestamp: "2:36 PM"
  }
];
    ...
    <div className="absolute left-[-104px] top-[-100px] inline-flex w-[600px] flex-col items-start justify-start overflow-hidden rounded-xl">
      ...
      <div className="flex flex-col h-full max-w-full bg-background border rounded-lg shadow-sm scale-75 origin-bottom-right">
        ...
        <div className="p-4 border-b">
          ...
          <p className="text-sm text-muted-foreground">Ask me anything about your forms</p>
        </div>
